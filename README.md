...
**📊 Datos actuales** (actualizado: 2025-11-10): - **Cobertura**: Dic
2007 - Sep 2025 - **Registros**: 11,554 observaciones - **Bienes**: 53
artículos únicos (limpios y estandarizados) - **Costo actual**: C\$
20,559 (-0.2% vs mes anterior)
...
#>    <chr>     <dbl> <fct> <chr>    <dbl> <chr> <chr>     <dbl>  <dbl> <dbl> <dbl>
...
- ✅ **Siempre actualizado**: Se actualiza mensualmente con los datos
  más recientes
...
Este proyecto proporciona a investigadores, formuladores de políticas y
ciudadanos:
...
*Mantenido por @RRMaximiliano \| Última actualización: 2025-11-10*
